...
import xml.booking.serviceregistry.model.JwtToken;
import xml.booking.serviceregistry.repositories.JwtTokenRepository;
...
public class JwtTokenProvider {
    ...
    public UserDetails getUserDetails(String token) {
        ...
        UserDetails userDetails = new UserDetails(userName,roleList.toArray(new String[roleList.size()]));
        return userDetails;
    }
